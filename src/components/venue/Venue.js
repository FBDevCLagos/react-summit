      ...
      return (
         <LeafletMap center={position} zoom={this.state.zoom}>
            ...
            <Marker position={position}>
               <Popup>Havilah Events Center (Lagos, Nigeria)</Popup>
            </Marker>
         </LeafletMap>
      );
   }
...
export default () => (
   <div id="venue">
      ...
      <div className="side-panel__content">
         <h3>Havilah Events Center, Yaba, Lagos</h3>

         <p>
            The 2018 React Summit will take place at Havilah Events Center, 1/3 Ijaoye
            street by Igbobi-Sabe, Jibowu, Yaba, Lagos.
         </p>
      </div>
   </div>
);
