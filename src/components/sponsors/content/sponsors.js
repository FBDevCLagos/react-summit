export const sponsorsList = [
  {
    name: "Facebook",
    introText: "Developer Circles from Facebook is a great way for developers to connect and collaborate. Each Circle is locally organized by members of the community.",
